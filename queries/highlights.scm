...
((type_reference name: (identifier) @type.builtin)
  (#any-of? @type.builtin
    ...
    "CollectionService" "Color3" "Color3Value" "ColorCorrectionEffect" "ColorGradingEffect"
    "ColorSequence" "ColorSequenceKeypoint" "CommerceService" "CompositeValueCurve" "CompressorSoundEffect"
    "ConeHandleAdornment" "ConfigService" "ConfigSnapshot" "Configuration" "ConfigureServerService"
    "Constraint" "Content" "ContentProvider" "ContextActionService" "Controller"
    "ControllerBase" "ControllerManager" "ControllerPartSensor" "ControllerSensor" "ControllerService"
    "CookiesService" "CoreGui" "CoreGuiConfiguration" "CoreScriptDebuggingManagerHelper" "CornerWedgePart"
    ...
    "PublishService" "PyramidHandleAdornment" "QWidgetPluginGui" "RBXScriptConnection" "RBXScriptSignal"
    ...
    "Script" "ScriptBuilder" "ScriptContext" "ScriptDebuggerService" "ScriptDocument"
    "ScriptEditorService" "ScriptProfilerService" "ScriptService" "ScrollingFrame" "Seat"
    "Secret" "SecurityCapabilities" "Selection" "SelectionBox" "SelectionHighlightManager"
    "SelectionLasso" "SelectionPartLasso" "SelectionPointLasso" "SelectionSphere" "SelfViewConfiguration"
    "SensorBase" "SerializationService" "ServerReplicator" "ServerScriptService" "ServerStorage"
    "ServiceProvider" "SessionCheckService" "SharedTable" "SharedTableRegistry" "Shirt"
    "ShirtGraphic" "SkateboardController" "SkateboardPlatform" "Skin" "Sky"
    "SlidingBallConstraint" "SlimContentProvider" "Smoke" "SmoothVoxelsUpgraderService" "Snap"
    ...
    "SphereHandleAdornment" "SpotLight" "SpringConstraint" "StandalonePluginScripts" "StandardPages"
    "StarterCharacterScripts" "StarterGear" "StarterGui" "StarterPack" "StarterPlayer"
    "StarterPlayerScripts" "StartupMessageService" "Stats" "StatsItem" "Status"
    ...
    "SurfaceSelection" "SwimController" "SyncScriptBuilder" "TaskScheduler" "Team"
    "TeamCreateData" "TeamCreateService" "Teams" "TeleportAsyncResult" "TeleportOptions"
    "TeleportService" "Terrain" "TerrainDetail" "TerrainRegion" "TestService"
    "TextBox" "TextBoxService" "TextButton" "TextChannel" "TextChatCommand"
    "TextChatConfigurations" "TextChatMessage" "TextChatMessageProperties" "TextChatService" "TextFilterResult"
    "TextFilterTranslatedResult" "TextGenerator" "TextLabel" "TextService" "TextSource"
    "Texture" "TimerService" "Tool" "Torque" "TorsionSpringConstraint"
    ...
    "UnionOperation" "UniqueIdLookupService" "UniversalConstraint" "UnreliableRemoteEvent" "User"
    "UserGameSettings" "UserInputService" "UserService" "UserSettings" "VRService"
    "VRStatusService" "ValueBase" "ValueCurve" "ValueCurveKey" "Vector2"
    "Vector2int16" "Vector3" "Vector3Curve" "Vector3Value" "Vector3int16"
    "VectorForce" "VehicleController" "VehicleSeat" "VelocityMotor" "VideoCapture"
    "VideoCaptureService" "VideoDisplay" "VideoFrame" "VideoPlayer" "VideoSampler"
    "VideoService" "ViewportFrame" "VirtualInput" "VirtualInputManager" "VirtualUser"
    "VisibilityCheckDispatcher" "Visit" "VoiceChatService" "WebStreamClient" "WedgePart"
    "Weld" "WeldConstraint" "Wire" "WireframeHandleAdornment" "Workspace"
    "WorkspaceAnnotation" "WorldModel" "WorldRoot" "WrapDeformer" "WrapLayer"
